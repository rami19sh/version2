...
class TestTestcase6():
    ...
    def test_testcase6_step1(self):
        ...
        self.driver.find_element(By.CSS_SELECTOR,
                                 ".carousel__snap-point:nth-child(1) .b-img").click()
        time.sleep(8)
    ...
    def test_test3(self):
        ...
        self.driver.find_element(By.ID,
                                 "s0-0-20-10-11-electro-wireless-1346549252-144195215991-qty[]-1-dropdown").click()
        dropdown = self.driver.find_element(By.ID,
                                            "s0-0-20-10-11-electro-wireless-1346549252-144195215991-qty[]-1-dropdown")
        time.sleep(3)
        dropdown.find_element(By.XPATH, "//option[. = '2']").click()
        time.sleep(3)
        price_unit = self.driver.find_element(By.CSS_SELECTOR,
                                              "#mainContent > div > div.right-section > div > div.table > div:nth-child(1) > div.val-col > span > span > span").text
        pu = float_price(price_unit)
        price_shipping = self.driver.find_element(By.CSS_SELECTOR,
                                                  "#mainContent > div > div.right-section > div > div.table > div:nth-child(2) > div.val-col > span > span > span").text
        psh = float_price(price_shipping)
        price_import = self.driver.find_element(By.CSS_SELECTOR,
                                                "#mainContent > div > div.right-section > div > div.table > div:nth-child(3) > div.val-col > span > span > span").text
        pi = float_price(price_import)
        total_price = self.driver.find_element(By.CSS_SELECTOR,
                                               "#mainContent > div > div.right-section > div > div.table > div:nth-child(5) > div.val-col.total-row > span > span > span").text
